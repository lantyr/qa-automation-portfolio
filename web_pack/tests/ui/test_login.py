"""
Suite: SauceDemo PC login (Playwright Chromium)
...
class TestWebLogin:
    ...
    """
    UI-LOG-003: Wrong password is rejected without leaking account existence.
    Steps:
      1. Submit standard_user / wrong-password
    Expected: generic error visible; message does not differentiate user-exists vs wrong-pass.
    """
